...
type EmptyIcon = 'document' | 'image' | 'message' | 'default'
...
const emptyIcons: Record<EmptyIcon, ReactNode> = {
  document: (
...
/**
 * Empty state for tables with icon, title, message, and optional action
 */
    ...
    <tr>
      <td colSpan={columns} className="px-4 py-16 text-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className={`${title ? 'mt-1' : 'mt-4'} text-sm text-gray-500 dark:text-gray-400`}>
            {message}
          </p>
          {action && (
            <Button
